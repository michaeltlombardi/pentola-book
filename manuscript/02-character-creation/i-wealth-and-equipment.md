...
In Pentola, wealth is abstracted and represented by a [usage die]().
Characters are assumed to start with a default wealth of _average_ (a d8 usage die).
...
|:-------:|:----------:|:--------------------------:|:---------:|:------------------|
|    1    | Destitute  | Beggars                    | **d4**    | A glass of wine
...
Whenever you make a sizable purchase, including buying additional starting equipment, you must roll your usage die at least once (more expensive items require more rolls).
On a roll of a 1, your usage die decreases in size as normal.
Note that if your usage die decreases due to a purchase and you're making multiple rolls, the remaining rolls are made with the new usage die.
...
If you're destitute and your usage die reduces you cannot make any more purchases until you recover resources.

Whenever you make a sizable sale, roll your usage die (as with purchases, more valuable items require multiple rolls).
...
If your usage die increases due to a purchase the remaining rolls are made with the new usage die.
...
G>
G> - Every 100 silver pieces in Runequest is roughly equal to a wealth roll.
G> - Every 10 gold pieces in an OSR game is roughly equal to a wealth roll.
G> - Every 25 gold pieces in a newer edition is roughly equal to a wealth roll.
G>
...
G> #### Improving Wealth
G>
G> Karacter started play with Average wealth and wants to increase it to Well-Off.
G>
G> The difference in IP costs is 11 - 7, so Karacter would pay 4 IP to increase their wealth.
G>
G> If Karacter wanted to instead increase their wealth from Average to Wealthy, they would pay 8 IP.
...
Each step up in usage die costs a wealth roll unless the armor has the expensive or cheap qualities.

When purchasing armor, roll your wealth usage die once for each AP the armor provides, unless it has the cheap or expensive qualities.

{icon=dice-d20}
G> #### Armor In Play
G>
G> Karacter started play with a padded shirt (AP 1, d6 usage die, cheap).
...
G> After a fight where they were hurt, Karacter must roll for their armor to see if it has been damaged.
G> They roll a 1 and the usage die reduces to a d4.
G>
G> Karacter can take their padded shirt to be repaired (one wealth roll) or attempt to repair it themself.
G>
G> Later, Karacter acquires a plated cap (AP 1, d8 usage die) and decides to wear it, increasing their AP to 2.
...
- **Plate:** Shaped plated of bronze provide superior protection for the wearer at the cost of weight and high value.
...
- **Expensive:** Armor with this quality must be made to order and requires an additional wealth roll to purchase and repair.
...
| Plate Helm (Closed)    | 2  |    d10    | Expensive, Deadened Hearing, Limited Vision
| Plate Vambraces        | 1  |    d10    | Expensive
| Plated Cap             | 1  |    d8     |
| Plated Coat            | 3  |    d8     | Heavy
| Scale Shirt            | 3  |    d8     | Heavy, Easily Repairable
| Scale Skirt            | 2  |    d8     | Heavy, Easily Repairable
| Scale Hauberk          | 4  |    d8     | Heavy, Easily Repairable
| Linen Shirt            | 2  |    d6     | Cheap
| Linen Skirt            | 1  |    d6     | Cheap
| Linen Greaves          | 1  |    d6     | Cheap
| Linen Vambraces        | 1  |    d6     | Cheap
| Linen Helm (Open)      | 1  |    d6     | Deadened Hearing
...
These items require an additional wealth roll for each step of improvement over the base item.
...
G>
G> - Enamelled Vambraces of the Sphinx: AP 1, d8, Fashionable, Expensive (three wealth rolls).
...
G> - Lion Bone Helm: AP 1, d8, Dampened Hearing, Fashionable, (four wealth rolls).
...
G> - Padded Thinking Cap: AP 2, d6 (four wealth rolls).
G>   This cap is made of woven silk and the weave itself is an homage to Archives, showing small scrolls and quills.
G>   It grants the wearer +1 to their Intellect while worn.
G> - Grave Greaves: AP 1, d10, Expensive (three wealth rolls).
...
G> - Exploding Scale Hauberk: AP 3, d12, Heavy, (6 wealth rolls).
...
G> - Artisanal Linen Skirt: AP 2, d8 (three wealth rolls).
G>   This bands of this linen skirt detail an idyllic scene of peace in a spire garden.
...
G> This is because weapons are not normally acquired by general citizens - characters in Pentola tend to get involved in all sorts of trouble and adventures that most citizens try very hard to avoid.
G> Weapons also make for pretty good treasure and can be traded for other equipment because of their expense.
G>
G> You could make acquiring weapons cheaper by removing the usage die cost, but be mindful that weapons are some of the most plentiful items the characters will be looting.
...
- **Expensive:** Weapons with this quality require an additional wealth roll to purchase and repair.
- **Easily Repairable:** Armor with this quality is easier and cheaper to repair; roll twice on the usage die when repairing it yourself or make only one wealth roll to have it repaired to full if being done professionally.
...
| Pouch of Sling Bullets   |    d12    | -
| Grappling Hook           |     -     | -
| Quills (5)               |    d4     | Each quill has a usage die, roll once per scroll scribed
...
{icon=dice-d20}
G> #### Example: Determining Wealth and Buying Equipment for Karacter
G>
G> We decide to have Karacter forego one level of wealth and begin play as Poor to gain an addition three improvement points immediately.
G>
G> This means picking up any additional starting equipment is going to be a bit dicey.
G>
G> We chose Knight for Karacter's archetype earlier, so we'll just use that equipment to start.
G>
G> That nets us some good armor, a sword and shield, a lance, a dagger, and equipment for drakeriding.
G>
G> To round out Karacter though, we want to pick up a lantern and two flasks of oil - it'd be nice to grab a bow and some arrows, but starting with a wealth of Poor, that's pretty risky.
G>
G> We roll against Karacter's wealth (a d6) for each item in order:
G>
G> - For the lantern we roll a 6 and suffer no substantial loss in funds.
G> - For the first flask of oil we roll a 2.
G> - For the second flask, however, we roll a 1 - reducing our wealth die to a d4!
G>   If Karacter buys anything else and rolls a 1, they'll become Destitute!
G>
G> Looks like Karacter _definitely_ isn't going to be starting with a bow!
